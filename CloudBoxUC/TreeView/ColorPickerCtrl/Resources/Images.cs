...
namespace CloudBox.Controller
{
	...
	class SelectorImages
	{
		...
		static public ImageList ImageList()
		{
			...
			if (m_imageList == null)
                m_imageList = ImagesUtil.GetToolbarImageList(t, "CloudBoxUC.Resources.colorbarIndicators.bmp", new Size(12, 12), Color.Magenta);
			return m_imageList;
		}
	...
	class PopupContainerImages
	{
		...
		static public ImageList ImageList()
		{
			Type t = typeof(SelectorImages);
			if (m_imageList == null)
                m_imageList = ImagesUtil.GetToolbarImageList(t, "CloudBoxUC.Resources.popupcontainerbuttons.bmp", new Size(16, 16), Color.Magenta);
			return m_imageList;
		}
		static public Image Image(eIndexes index)
		{
