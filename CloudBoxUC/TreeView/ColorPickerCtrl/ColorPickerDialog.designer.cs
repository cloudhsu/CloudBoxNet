namespace CloudBox.Controller
{
	partial class ColorPickerDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_colorList = new CloudBox.Controller.ColorListBox();
			this.m_systemColorsTabPage = new System.Windows.Forms.TabPage();
			this.m_systemColorList = new CloudBox.Controller.SystemColorListBox();
		...
		private CloudBox.Controller.ColorListBox m_colorList;
		private CloudBox.Controller.SystemColorListBox m_systemColorList;
	}
}
